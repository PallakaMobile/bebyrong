...
/*    fun setUsername(name: String) = saveString("nama", name)
    fun setEmail(email: String) = saveString("email", email)
    fun setImageUrl(image: String) = saveString("image", image)

    fun getUsername(): String = getString("nama")
    fun getEmail(): String = getString("email")
    fun getImageUrl(): String = getString("image")*/
