...
import ps.bebyrong.databinding.FragmentNewsCategoryItemBinding
 ...
 */
class NewsCategoryAdapter : RecyclerView.Adapter<NewsCategoryAdapter.NewsCategoryHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NewsCategoryHolder =
            NewsCategoryHolder(DataBindingUtil.inflate(LayoutInflater.from(parent.context), R.layout.fragment_news_category_item, parent, false))
    ...
    inner class NewsCategoryHolder(private val binding: FragmentNewsCategoryItemBinding) : RecyclerView.ViewHolder(binding.root) {
